	...
	return (
		<div>
			...
			<div className="mt-5">
				...
				<p>After installing the dependencies, you can use <code>npm run dev</code> command to run the project on local server, it will run on http://localhost:3000 by default.</p>
			</div>
		</div>
	)
}
